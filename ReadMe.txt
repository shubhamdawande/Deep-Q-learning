...
action space: discrete, state space: continuous
...
model/tensorboard graphs are saved in models/tensorboard folders
After training for 100 episodes our model can achieve average score of ~200
